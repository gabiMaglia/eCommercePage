...
CREATE TABLE "Category" (
    ...
    "name" TEXT NOT NULL,
    "image" TEXT NOT NULL DEFAULT 'https://www.kindpng.com/picc/m/459-4595417_category-overview-icon-hd-png-download.png',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "ProductDescription" (
    "id" TEXT NOT NULL,
    "productId" TEXT NOT NULL,
    "generalDescription" TEXT NOT NULL DEFAULT ' ',
    "caracteristics" TEXT NOT NULL DEFAULT '[]',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
